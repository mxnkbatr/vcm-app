...
const DATA = {
  hero: {
    ...
    sub: "Альпийн нуруу, Венийн вальс, түүх соёлын гайхамшигт улсад ажиллаж амьдрах боломж.",
    cta: "Дэлгэрэнгүй Мэдээлэл"
  },
  intro: "Au-Pair хөтөлбөр нь Монгол залууст гадаадад амьдарч, шинэ соёлтой танилцаж, тус улсын хэлийг орчинд сурч, туршлага хуримтлуулах боломжийг олгодог. Австрийн зочин гэр бүлийн нэг гишүүн болж, хэл сурангаа аялах боломж.",
  austriaInfo: {
    title: "Австри Улсын Тухай",
    desc: "Төв Европын урд бүсийн Альпийн нурууны зүүн хэсэгт байрладаг. Нийслэл нь Вена хот. Дэлхийн шилдэг хөгжмийн зохиолч Моцартын эх орон бөгөөд аялал жуулчлал, боловсрол, урлагийн өндөр хөгжилтэй улс.",
    stats: [
  ...
  contract: [
    { icon: Clock, title: "Ажлын Цаг", desc: "Долоо хоногт 18 хүртэл цаг." },
    { icon: FaMoneyBillWave, title: "Халаасны Мөнгө", desc: "Сар бүр 520 Евро." },
    { icon: FaGraduationCap, title: "Сургалтын Төлбөр", desc: "Гэр бүл хэлний курсийн зардлын 50%-ийг төлнө." },
    { icon: FaPassport, title: "Хугацаа", desc: "Гэрээ 6-12 сар." },
  ],
  housing: [
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-white text-slate-800 font-sans selection:bg-[#E3002D] selection:text-white overflow-hidden">
      ...
      <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 px-6 overflow-hidden">
         ...
         <div className="absolute top-20 right-[-10%] w-[600px] h-[600px] bg-gradient-to-br from-[#FFD100] via-[#FDE047] to-transparent rounded-full blur-[100px] opacity-40 mix-blend-multiply animate-pulse-slow" />
            ...
            <div className="space-y-4 mb-20 relative">
               ...
               {DATA.schedule.map((sch, i) => (
                  <motion.div 
                     ...
                     className="flex flex-col md:flex-row justify-between items-center bg-white p-6 rounded-3xl shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-slate-100 hover:border-[#E3002D] hover:shadow-xl transition-all group z-10 relative"
                  >
                     <div className="flex items-center gap-6 mb-4 md:mb-0 w-full md:w-auto">
                        <div className="w-14 h-14 rounded-2xl bg-slate-50 flex items-center justify-center font-black text-slate-400 group-hover:bg-[#E3002D] group-hover:text-white transition-colors shrink-0">
                           {i + 1}
                        </div>
                        <div className="text-left">
                           <p className="font-black text-slate-900 text-lg group-hover:text-[#E3002D] transition-colors">{sch.date}</p>
                           <p className="font-medium text-slate-500 text-sm">{sch.type}</p>
                        </div>
                     </div>
                     <div className="flex items-center gap-2 font-bold text-[#00C1B6] bg-teal-50 px-5 py-3 rounded-2xl w-full md:w-auto justify-center">
