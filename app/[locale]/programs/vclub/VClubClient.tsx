...
export default function VClubClient() {
   const t = useTranslations("VClubPage");
   ...
   const stats = [
      ...
      { label: t("info.stats.network.label"), val: t("info.stats.network.val") },
   ];
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
               ...
               <div className="relative h-[550px] hidden lg:block">
                  ...
                  >
                     ...
                     <p className="text-slate-600 font-medium italic mb-4">"Being part of V-Club changed how I see community impact. We are stronger together."</p>
                     <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-sky-100" />
                        <p className="text-xs font-black uppercase text-slate-800 tracking-widest">Sarah L. — V-Club Lead</p>
                     </div>
                  </motion.div>
               </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
               ...
               <div className="space-y-8">
                  <h3 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
                     Collective <span className="text-sky-500">Power</span> <br />
                     Driving Real Change
                  </h3>
                  <div className="grid gap-4">
                     {[
                        { icon: FaGlobe, title: "Global Connection", desc: "Network with change-makers and social innovators from all around the world." },
                        { icon: FaHandshake, title: "Stronger Bonds", desc: "Build lasting professional and personal relationships through social impact." }
                     ].map((item, i) => (
         ...
         <section className="py-16 px-6">
            <div className="max-w-4xl mx-auto text-center bg-slate-900 rounded-[2rem] p-10 md:p-14 shadow-xl relative overflow-hidden">
               ...
               <h2 className="text-3xl md:text-4xl font-black text-white mb-4 relative z-10">
                  Launch Your <span className="text-sky-400">V-Club</span> Journey
               </h2>
               <p className="text-sm text-slate-400 font-medium mb-8 max-w-md mx-auto relative z-10">
                  Connect, collaborate, and contribute to a growing global movement of positive social impact.
               </p>
               <Link href="/register" className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-full bg-sky-500 text-white font-black text-xs uppercase tracking-widest hover:bg-sky-600 hover:-translate-y-0.5 transition-all shadow-lg shadow-sky-500/30 group relative z-10 font-sans">
                  Join the Club <FaRocket className="group-hover:translate-x-1 transition-transform" />
               </Link>
            </div>
         </section>
