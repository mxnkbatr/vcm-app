...
export default function EduClient() {
   const t = useTranslations("EduPage");
   ...
   const stats = [
      ...
      { label: t("info.stats.reach.label"), val: t("info.stats.reach.val") },
   ];
               ...
               <div className="relative h-[550px] hidden lg:block">
                  ...
                  >
                     <div className="relative w-full h-full rounded-[1.5rem] overflow-hidden bg-slate-50">
                        <Image 
                           src="https://images.unsplash.com/photo-1577896851231-70ef18881754?auto=format&fit=crop&w=1200&q=90" 
                           alt="EDU Program" 
                           fill 
                  ...
                  >
                     ...
                     <p className="text-slate-600 font-medium italic mb-4">"Inspiring students while learning from a new culture was the highlight of my year."</p>
                     <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-full bg-sky-100" />
                        <p className="text-xs font-black uppercase text-slate-800 tracking-widest">James W. — Global Teacher</p>
                     </div>
                  </motion.div>
               </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
               ...
               >
                  ...
                  <div className="grid grid-cols-3 gap-4">
                     {stats.map((s, i) => (
                        <div key={i} className="bg-slate-50 p-3 rounded-xl text-center border border-white">
                           <p className="text-[9px] font-black uppercase text-sky-500 mb-0.5">{s.label}</p>
               ...
               <div className="space-y-8">
                  <h3 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
                     Educational <span className="text-sky-500">Excellence</span> <br />
                     Igniting Young Minds
                  </h3>
                  <div className="grid gap-4">
                     {[
                        { icon: FaLightbulb, title: "Sparking Potential", desc: "Share your unique skills to inspire curiosity and academic growth." },
                        { icon: FaChalkboardTeacher, title: "Classroom Impact", desc: "Support local schools and learning centers with innovative methods." }
                     ].map((item, i) => (
                        <div key={i} className="flex gap-4 p-5 rounded-xl hover:bg-white hover:shadow-lg hover:shadow-slate-200/40 transition-all cursor-default group">
                           <div className="w-10 h-10 shrink-0 rounded-lg bg-sky-50 flex items-center justify-center text-sky-500 text-lg font-black group-hover:scale-110 transition-transform">
                              <item.icon />
                           </div>
                           <div>
         ...
         <section className="py-16 px-6">
            <div className="max-w-4xl mx-auto text-center bg-slate-900 rounded-[2rem] p-10 md:p-14 shadow-xl relative overflow-hidden">
               ...
               <h2 className="text-3xl md:text-4xl font-black text-white mb-4 relative z-10">
                  Join the <span className="text-sky-400">EDU-Volunteer</span> Force
               </h2>
               <p className="text-sm text-slate-400 font-medium mb-8 max-w-md mx-auto relative z-10">
                  Help us build a brighter future for the next generation. Your knowledge is our greatest asset.
               </p>
               <Link href="/register" className="inline-flex items-center justify-center gap-2 px-10 py-4 rounded-full bg-sky-500 text-white font-black text-xs uppercase tracking-widest hover:bg-sky-600 hover:-translate-y-0.5 transition-all shadow-lg shadow-sky-500/30 group relative z-10 font-sans">
                  Become a Teacher <FaPlaneDeparture className="group-hover:translate-x-1 transition-transform" />
               </Link>
            </div>
         </section>
