...
const DATA = {
  hero: {
    ...
    sub: "Европын зүрхэнд, амтат шоколад, түүхэн соёлын дунд зочин гэр бүлтэйгээ нэгдээрэй. Франц, Голланд, Герман хэлийг нэгэн зэрэг сурах алтан боломж.",
    cta: "Аяллаа Эхлүүлэх"
  },
  belgiumInfo: {
    title: "Бельги Улсын Тухай",
    desc: "Баруун Европын төвд оршдог, 11 сая хүн амтай, Франц, Голланд, Герман гэсэн 3 хэлтэй олон соёлт улс. Нийслэл Брюссель нь Европын Холбооны төв бөгөөд олон улсын байгууллагууд төвлөрсөн улс төр, эдийн засгийн зангилаа юм. Бельги улсад Au Pair хийснээр олон талт соёлтой танилцах өргөн боломжтой.",
    stats: [
  ...
  benefits: [
    ...
    { title: "1000€ Сургалтын Бэлэг", sub: "Хэлний курсийн төлбөр багтсан", icon: FaGraduationCap, color: "text-blue-600" },
  ]
};
      ...
      <section className="relative pt-32 pb-24 px-6 min-h-[90vh] flex items-center justify-center overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="space-y-8 text-center lg:text-left">
               ...
               <p className="text-xl text-slate-600 font-medium leading-relaxed max-w-lg mx-auto lg:mx-0">{DATA.hero.sub}</p>
